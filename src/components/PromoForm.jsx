...
const ONSITE_SUBTYPES = ['Cashback / Kayıp İade', 'Bet & Get', 'Leaderboard', 'Free Bet / Bedava Bahis', 'Deposit Match', 'Other']
...
export default function PromoForm({ promo, onSave, onClose }) {
  ...
  const handleSubmit = async () => {
    if (!form.name.trim()) return alert('Promo name is required')
        ...
        <div className="modal-body">
          ...
          <div className="form-row-3">
            ...
            <div className="form-group" style={{ gridColumn: 'span 2' }}>
              ...
              <input
                placeholder="e.g. Weekend Reload — VIP Segment"
                value={form.name}
          ...
          <div className="form-row">
            <div className="form-group">
              ...
              <input
                ...
                value={form.min_odds}
                onChange={e => set('min_odds', e.target.value)}
              />
            </div>
            <div className="form-group">
              <label>Status</label>
